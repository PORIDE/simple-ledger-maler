...
const Button = ({ children, variant = 'primary', icon: Icon, onClick, className = '' }) => {
  ...
  const variants = {
    primary: "bg-[#6E7F8D] dark:bg-[#E4E4E7] text-white dark:text-[#18181B] hover:bg-[#5b6b78] dark:hover:bg-[#d4d4d8] shadow-sm",
    secondary: "bg-[#F3F4F6] dark:bg-[#3F3F46] text-[#2C3E50] dark:text-[#F4F4F5] hover:bg-[#E5E7EB] dark:hover:bg-[#2D2D30]",
    ghost: "bg-transparent text-[#6E7F8D] dark:text-[#A1A1AA] hover:bg-[#F3F4F6] dark:hover:bg-[#27272A]",
...
const Input = ({ label, value, onChange, placeholder, type = "text", className = "", readOnly = false }) => (
  <div className={`flex flex-col gap-1 ${className}`}>
    {label && <label className="text-xs font-bold text-[#7F8C8D] dark:text-[#A1A1AA]">{label}</label>}
    <input
      type={type}
      value={value}
      ...
      className={`w-full border rounded-lg px-3 py-2 text-[16px] focus:outline-none focus:ring-2 
        ${readOnly 
            ? 'bg-[#F3F4F6] dark:bg-[#3F3F46] text-[#9CA3AF] border-transparent cursor-default' 
            : 'bg-[#F3F4F6] dark:bg-[#3F3F46] border-[#E5E7EB] dark:border-[#3F3F46] text-[#2C3E50] dark:text-[#F4F4F5] focus:ring-[#6E7F8D] dark:focus:ring-[#71717A]'
        }`}
    />
  </div>
);
    ...
    <div className={`flex flex-col gap-1 ${className}`}>
        ...
        <div className="relative">
            <select
                ...
                className="w-full appearance-none bg-[#F3F4F6] dark:bg-[#3F3F46] border border-[#E5E7EB] dark:border-[#3F3F46] rounded-lg px-3 py-2 text-[#2C3E50] dark:text-[#F4F4F5] focus:outline-none focus:ring-2 focus:ring-[#6E7F8D] dark:focus:ring-[#71717A] text-[16px]"
            >
                {options.map(opt => (
...
const DashboardView = ({ onCreate }) => (
    <div className="flex flex-col items-center justify-center min-h-screen p-8 max-w-4xl mx-auto w-full text-center">
      <div className="mb-12">
        <h1 className="text-4xl font-black text-[#2C3E50] dark:text-[#F4F4F5] mb-4 tracking-tight">
            しんぷる帳票
        </h1>
        <p className="text-[#7F8C8D] dark:text-[#A1A1AA] max-w-lg mx-auto leading-relaxed">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-2xl mb-12">
        <button 
            ...
            className="group relative overflow-hidden flex flex-col items-center justify-center p-8 bg-white dark:bg-[#27272A] border-2 border-[#E5E7EB] dark:border-[#3F3F46] rounded-2xl hover:border-[#6E7F8D] dark:hover:border-[#F4F4F5] hover:shadow-xl transition-all duration-300"
        >
            <div className="w-20 h-20 bg-[#EFF2F9] dark:bg-[#3F3F46] rounded-full flex items-center justify-center text-[#6E7F8D] dark:text-[#F4F4F5] mb-6 group-hover:scale-110 transition-transform duration-300">
                <Receipt size={40} strokeWidth={1.5} />
            </div>
            <span className="text-xl font-bold text-[#2C3E50] dark:text-[#F4F4F5]">請求書を作成</span>
        ...
        <button 
            ...
            className="group relative overflow-hidden flex flex-col items-center justify-center p-8 bg-white dark:bg-[#27272A] border-2 border-[#E5E7EB] dark:border-[#3F3F46] rounded-2xl hover:border-[#6E7F8D] dark:hover:border-[#F4F4F5] hover:shadow-xl transition-all duration-300"
        >
            <div className="w-20 h-20 bg-[#F3F4F6] dark:bg-[#3F3F46] rounded-full flex items-center justify-center text-[#6E7F8D] dark:text-[#F4F4F5] mb-6 group-hover:scale-110 transition-transform duration-300">
                <FileText size={40} strokeWidth={1.5} />
            </div>
            <span className="text-xl font-bold text-[#2C3E50] dark:text-[#F4F4F5]">見積書を作成</span>
...
const EditorView = ({ 
    ...
    return (
        <div className="min-h-screen flex flex-col bg-[#F9FAFB] dark:bg-[#18181B]">
            {/* Editor Header */}
            <div className="bg-white dark:bg-[#202023] border-b border-[#E5E7EB] dark:border-[#3F3F46] p-4 flex justify-between items-center sticky top-0 z-30 shadow-sm">
                <div className="flex items-center gap-3">
                    <button onClick={onHome} className="p-2 -ml-2 rounded-full hover:bg-[#F3F4F6] dark:hover:bg-[#3F3F46] text-[#6E7F8D]">
                        <Home size={20} />
                    </button>
                    <h2 className="font-bold text-[#2C3E50] dark:text-[#F4F4F5] text-lg">
            ...
            <div className="flex-1 p-4 md:p-8 max-w-4xl mx-auto w-full pb-32">
                ...
                <section className="mb-8">
                    <h3 className="flex items-center gap-2 text-[#6E7F8D] dark:text-[#A1A1AA] font-bold text-sm mb-3 px-1">
                        <FileText size={16}/> 基本情報
                    </h3>
                    <div className="bg-white dark:bg-[#27272A] rounded-xl shadow-sm p-6 border border-[#E5E7EB] dark:border-[#3F3F46]">
                        <div className="mb-6">
                            <Input 
                                label="件名 (案件名)" 
                        ...
                        <div className="mb-6">
                            <label className="text-xs font-bold text-[#7F8C8D] dark:text-[#A1A1AA] mb-1 block">顧客を選択または入力</label>
                            <div className="flex gap-2">
                                <input
                                    type="text"
                                    placeholder="顧客名を入力または選択"
                                    className="flex-grow w-full bg-[#F3F4F6] dark:bg-[#3F3F46] border border-[#E5E7EB] dark:border-[#3F3F46] rounded-lg px-3 py-2 text-[#2C3E50] dark:text-[#F4F4F5] focus:outline-none focus:ring-2 focus:ring-[#6E7F8D] dark:focus:ring-[#71717A] text-[16px]"
                ...
                <section className="mb-8">
                    <div className="flex justify-between items-end mb-3 px-1">
                        <h3 className="flex items-center gap-2 text-[#6E7F8D] dark:text-[#A1A1AA] font-bold text-sm">
                            <CheckCircle size={16}/> 明細入力 (最大6行)
                        </h3>
                    </div>
                    
                    <div className="bg-white dark:bg-[#27272A] rounded-xl shadow-sm p-6 border border-[#E5E7EB] dark:border-[#3F3F46]">
                        <div className="hidden md:grid grid-cols-12 gap-3 text-xs font-bold text-[#7F8C8D] dark:text-[#A1A1AA] px-2 mb-3 border-b border-[#E5E7EB] dark:border-[#3F3F46] pb-2">
                        ...
                        {docItems.map((item, index) => {
                            ...
                            return (
                                <div key={item.id} className="grid grid-cols-1 md:grid-cols-12 gap-3 items-center bg-[#F9FAFB] dark:bg-[#202023] p-4 md:p-2 rounded-lg md:rounded-none md:bg-transparent border border-[#E5E7EB] dark:border-[#3F3F46] md:border-0 md:border-b md:border-dashed md:last:border-0">
                                    <div className="hidden md:block col-span-1 text-center text-xs text-[#9CA3AF] font-bold">{index + 1}</div>
                                    <div className="md:hidden text-xs font-bold text-[#7F8C8D] dark:text-[#A1A1AA] mb-1">品目</div>
                                    <div className="col-span-5">
                                        <input 
                                            className="w-full bg-transparent border-b border-[#E5E7EB] dark:border-[#3F3F46] md:border-0 focus:border-[#6E7F8D] focus:outline-none dark:text-[#F4F4F5] placeholder-[#9CA3AF]" 
                                    ...
                                    <div className="flex gap-4 md:contents">
                                        <div className="flex-1 md:col-span-2">
                                            <div className="md:hidden text-xs font-bold text-[#7F8C8D] dark:text-[#A1A1AA] mb-1">単価</div>
                                            <input 
                                                type="number"
                                                className="w-full bg-transparent border-b border-[#E5E7EB] dark:border-[#3F3F46] md:border-0 focus:border-[#6E7F8D] focus:outline-none text-right font-en dark:text-[#F4F4F5]" 
                                                placeholder="0"
                                                value={item.price}
                                                onChange={(e) => {
                                                    const newItems = [...docItems];
                                        ...
                                        <div className="w-20 md:w-auto md:col-span-1">
                                            <div className="md:hidden text-xs font-bold text-[#7F8C8D] dark:text-[#A1A1AA] mb-1">数量</div>
                                            <input 
                                                type="number"
                                                className="w-full bg-transparent border-b border-[#E5E7EB] dark:border-[#3F3F46] md:border-0 focus:border-[#6E7F8D] focus:outline-none text-right font-en dark:text-[#F4F4F5]" 
                                                placeholder="0"
                                    ...
                                    <div className="flex justify-between items-center md:col-span-2 md:justify-end mt-2 md:mt-0 pt-2 md:pt-0 border-t border-dashed border-[#E5E7EB] dark:border-[#3F3F46] md:border-0">
                                        <span className="md:hidden text-xs font-bold text-[#7F8C8D]">小計</span>
                                        <span className="text-[#2C3E50] dark:text-[#F4F4F5] font-en font-bold">
                        ...
                        {/* Tax Config */}
                        <div className="mt-6 flex flex-col md:flex-row gap-4 justify-end border-t border-[#E5E7EB] dark:border-[#3F3F46] pt-4">
                            <div className="flex items-center gap-2">
                                <label className="text-xs font-bold text-[#7F8C8D] dark:text-[#A1A1AA]">消費税(10%)</label>
                                <select 
                                    className="bg-[#F3F4F6] dark:bg-[#3F3F46] border border-[#E5E7EB] dark:border-[#3F3F46] rounded px-2 py-1 text-sm text-[#2C3E50] dark:text-[#F4F4F5] focus:outline-none"
                            ...
                            <div className="flex items-center gap-2">
                                <label className="text-xs font-bold text-[#7F8C8D] dark:text-[#A1A1AA]">源泉徴収税</label>
                                <select 
                                    className="bg-[#F3F4F6] dark:bg-[#3F3F46] border border-[#E5E7EB] dark:border-[#3F3F46] rounded px-2 py-1 text-sm text-[#2C3E50] dark:text-[#F4F4F5] focus:outline-none"
                        ...
                        {/* Totals */}
                        <div className="mt-4 pt-4 border-t border-[#E5E7EB] dark:border-[#3F3F46] flex flex-col md:flex-row justify-end items-end gap-2">
                            <div className="w-full md:w-1/2 p-4 bg-[#F9FAFB] dark:bg-[#202023] rounded-lg">
                                <div className="flex justify-between items-center mb-2">
                                    <span className="text-sm font-bold text-[#7F8C8D]">小計</span>
                                    <span className="font-en text-[#2C3E50] dark:text-[#F4F4F5]">¥{formatCurrency(calculations.subtotal)}</span>
                                </div>
                                {taxConfig.enableTax && (
                                    <div className="flex justify-between items-center mb-2">
                                        <span className="text-sm font-bold text-[#7F8C8D]">消費税 (10%)</span>
                                        <span className="font-en text-[#2C3E50] dark:text-[#F4F4F5]">+ ¥{formatCurrency(calculations.tax)}</span>
                                    </div>
                                )}
                                ...
                                <div className="flex justify-between items-end border-t border-[#E5E7EB] dark:border-[#3F3F46] pt-2 mt-2">
                                    <span className="text-base font-bold text-[#2C3E50] dark:text-[#F4F4F5]">合計金額</span>
                                    <span className="text-2xl font-black text-[#2C3E50] dark:text-[#F4F4F5] font-en">
                ...
                <section className="mb-8">
                    ...
                    <div className="bg-white dark:bg-[#27272A] rounded-xl shadow-sm p-6 border border-[#E5E7EB] dark:border-[#3F3F46]">
                        ...
                        {currentDoc.type === 'invoice' && (
                            <>
                                <h4 className="text-xs font-bold text-[#7F8C8D] dark:text-[#A1A1AA] mb-3 flex items-center gap-1 border-t border-[#E5E7EB] dark:border-[#3F3F46] pt-4">
                ...
                <section className="mb-12">
                    ...
                    <div className="bg-white dark:bg-[#27272A] rounded-xl shadow-sm p-6 border border-[#E5E7EB] dark:border-[#3F3F46]">
                        <textarea 
                            className="w-full bg-[#F9FAFB] dark:bg-[#3F3F46] border border-[#E5E7EB] dark:border-[#3F3F46] rounded-lg p-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#6E7F8D] dark:text-[#F4F4F5]"
                            rows={4}
...
const PreviewView = ({ currentDoc, companyInfo, docItems, calculations, onEdit }) => {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-[#555]">
            <div className="bg-white dark:bg-[#202023] border-b border-[#E5E7EB] dark:border-[#3F3F46] p-4 flex justify-between items-center z-30 shadow-sm sticky top-0">
                <div className="flex items-center gap-2">
                    <button onClick={onEdit} className="p-2 -ml-2 rounded-full hover:bg-[#F3F4F6] dark:hover:bg-[#3F3F46] text-[#6E7F8D]">
                        <ChevronLeft />
                    </button>
                    <h2 className="font-bold text-[#2C3E50] dark:text-[#F4F4F5] text-lg">プレビュー確認</h2>
                </div>
